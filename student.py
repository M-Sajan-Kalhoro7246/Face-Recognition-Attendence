...
class Student:
    def __init__(self,root):
        ...
        bg_img = Frame(self.root,bd=2,bg="black") #bd mean border 
        bg_img.place(x=0,y=20,width=680,height=540)
        ...
        lb1img2.place(x=620,y=0, width=50,height=35)
        ...
        # Left Label Frame 
        left_frame = LabelFrame(main_frame,bd=2,bg="black",relief=RIDGE,text="Student Details",font=("verdana",12,"bold"),fg="white")
        left_frame.place(x=10,y=10,width=660,height=480)

        # Current Course 
        current_course_frame = LabelFrame(left_frame,bd=2,bg="black",relief=RIDGE,text="Current Course",font=("verdana",12,"bold"),fg="white")
        current_course_frame.place(x=10,y=5,width=635,height=150)

        #label Department
        dep_label=Label(current_course_frame,text="PROGRAM",font=("verdana",12,"bold"),bg="black",fg="white")
        ...
        dep_combo["values"]=("Select Program","(BS)Computer Science","(MSc.)Computer Science","(MCS)Computer Science","(BS)Mathematics","(Msc.)Mathematics","(BS)Artificial Intelligence","(Mphil)Computer Science","(Mphil)Mathematics","(Ph.D)Computer Science","(Ph.D)Mathematics")
        dep_combo.current(0)
        dep_combo.current(0)
        ...
        cou_combo["values"]=("Select Course","Programming Fundamentals","ICT","Basic Electronics","Operating System","Analysis of Algorithms","Functional Maths","Vector Analysis","Statistics & Probabilty","Trignometry")
        dep_combo.current(0)
        cou_combo.current(0)
        ...
        year_combo["values"]=("Select Year","2011","2012","2013","2014","2015","2016","2017","2018","2019","2020","2021","2022","2023","2024","2025","2026","2027","2028","2029","2030")
        ...
        class_Student_frame = LabelFrame(left_frame,bd=2,bg="black",relief=RIDGE,text="Class Student Information",font=("verdana",12,"bold"),fg="white")
        class_Student_frame.place(x=10,y=160,width=635,height=230)

        #Student id
        studentId_label = Label(class_Student_frame,text="ID:",font=("verdana",12,"bold"),fg="white",bg="black")
        studentId_label.grid(row=0,column=0,padx=5,pady=5,sticky=W)

        studentId_entry = ttk.Entry(class_Student_frame,textvariable=self.var_std_id,width=16,font=("verdana",12,"bold"))
        ...
        student_name_entry = ttk.Entry(class_Student_frame,textvariable=self.var_std_name,width=16,font=("verdana",12,"bold"))
        ...
        div_combo=ttk.Combobox(class_Student_frame,textvariable=self.var_div,width=15,font=("verdana",12,"bold"),state="readonly")
        div_combo["values"]=("Select Shift:","Morning","Evening")
        div_combo.current(0)
        div_combo.grid(row=1,column=1,padx=5,pady=5,sticky=W)

        #Roll No
        student_roll_label = Label(class_Student_frame,text="RollNo:",font=("verdana",12,"bold"),fg="white",bg="black")
        student_roll_label.grid(row=1,column=2,padx=5,pady=5,sticky=W)

        student_roll_entry = ttk.Entry(class_Student_frame,textvariable=self.var_roll,width=16,font=("verdana",12,"bold"))
        ...
        #combo box 
        gender_combo=ttk.Combobox(class_Student_frame,textvariable=self.var_gender,width=15,font=("verdana",12,"bold"),state="readonly")
        ...
        student_dob_entry = DateEntry(class_Student_frame,selectmode='day',textvariable=self.var_dob,width=15,font=("verdana",12,"bold"))
        ...
        student_email_entry = ttk.Entry(class_Student_frame,textvariable=self.var_email,width=16,font=("verdana",12,"bold"))
        student_email_entry.grid(row=3,column=1,padx=5,pady=5,sticky=W)

        #Phone Number
        student_mob_label = Label(class_Student_frame,text="Phone No:",font=("verdana",12,"bold"),fg="white",bg="black")
        student_mob_label.grid(row=3,column=2,padx=5,pady=5,sticky=W)

        student_mob_entry = ttk.Entry(class_Student_frame,textvariable=self.var_mob,width=16,font=("verdana",12,"bold"))
        ...
        student_address_entry = ttk.Entry(class_Student_frame,textvariable=self.var_address,width=16,font=("verdana",12,"bold"))
        student_address_entry.grid(row=4,column=1,padx=5,pady=5,sticky=W)

        #Teacher Name
        student_teacher_label = Label(class_Student_frame,text="T-Name:",font=("verdana",12,"bold"),fg="white",bg="black")
        student_teacher_label.grid(row=4,column=2,padx=5,pady=5,sticky=W)

        student_teacher_entry = ttk.Entry(class_Student_frame,textvariable=self.var_teacher,width=16,font=("verdana",12,"bold"))
        student_teacher_entry.grid(row=4,column=3,padx=5,pady=5,sticky=W)

        #Radio Buttons
        self.var_radio1=StringVar()
        radiobtn1=ttk.Radiobutton(class_Student_frame,text="Face Recognize.?",variable=self.var_radio1,value="Yes")
        radiobtn1.grid(row=5,column=0,padx=5,pady=5,sticky=W)
        
        take_photo_btn=Button(class_Student_frame,bd=2,command=self.generate_dataset,text="Face Recognize",width=19,font=("verdana",10,"bold"),bg="black",fg="white")
        take_photo_btn.grid(row=5,column=1,padx=5,pady=5,sticky=W)
        
        
        #update photo button
        update_photo_btn=Button(class_Student_frame,bd=2,command=self.generate_dataset,text="Update Face Recognize",width=22,font=("verdana",9,"bold"),bg="black",fg="white")
        update_photo_btn.grid(row=5,column=3,padx=5,pady=5,sticky=W)
        ...
        #save button
        save_btn=Button(btn_frame,command=self.add_data,text="Save Data",bd=0,width=13,font=("verdana",12,"bold"),bg="navyblue",fg="white")
        save_btn.grid(row=0,column=0,padx=5,pady=10,sticky=W)

        #update button
        update_btn=Button(btn_frame,command=self.update_data,text="Update",bd=0,width=13,font=("verdana",12,"bold"),bg="navyblue",fg="white")
        update_btn.grid(row=0,column=1,padx=5,pady=8,sticky=W)

        #delete button
        del_btn=Button(btn_frame,command=self.delete_data,text="Delete",bd=0,width=12,font=("verdana",12,"bold"),bg="navyblue",fg="white")
        del_btn.grid(row=0,column=2,padx=5,pady=10,sticky=W)

        #reset button
        reset_btn=Button(btn_frame,command=self.reset_data,text="Reset",bd=0,width=12,font=("verdana",12,"bold"),bg="navyblue",fg="white")
    ...
    def add_data(self):
        ...
        if self.var_dep.get()=="Select Department" or self.var_course.get()=="Select Course" or self.var_year.get()=="Select Year" or self.var_semester.get()=="Select Month" or self.var_std_id.get()=="" or self.var_std_name.get()=="" or self.var_div.get()=="" or self.var_roll.get()=="" or self.var_gender.get()=="Select Gender" or self.var_dob.get()=="" or self.var_email.get()=="" or self.var_mob.get()=="" or self.var_address.get()=="" or self.var_teacher.get()=="":
            ...
            try:
                ...
                self.fetch_data()
                conn.close()
                Speak('Success All Records are Saved')
